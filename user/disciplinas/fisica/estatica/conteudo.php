...
<?php
    ...
    $get_conteudo = mysqli_query($conexao, "SELECT * FROM tema WHERE id_tema = 3");
		...
		<div class="escolha conteudo conteudo-fis">
			...
			<div class="conteudo">
				<div class="opcoes">
					...
					<div class="bt-fis">
						<a  href="estatica.php">Responder ao questionário</a>
					</div>
				</div>
			</div>
...
>>>>>>> 4571efdf84813d2f2c30fbba9d37aaa5bf85bf64:user/disciplinas/fisica/estatica/conteudo.html
</html>