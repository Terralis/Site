<<<<<<< HEAD:user/disciplinas/fisica/introducaoaoestudodafisica/conteudo.php
<?php
session_start();
...
<?php
    ...
    $get_conteudo = mysqli_query($conexao, "SELECT * FROM tema WHERE id_tema = 1");
						...
						<div class="wrapper-child" >
							...
							<div class="tab" name="video" id="video">
								<div class="material-video">
									<iframe width="600" height="337" src="https://www.youtube.com/embed/MLEZI03kUkE" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
									<iframe width="600" height="337" src="https://www.youtube.com/embed/wlTa_yTElGM" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
								</div>
							</div>
						</div>
					</div>
					<div class="bt-fis">
						<a  href="introducaoaoestudodafisica.php">Responder ao questionário</a>
					</div>
				</div>
			</div>
...
>>>>>>> 4571efdf84813d2f2c30fbba9d37aaa5bf85bf64:user/disciplinas/fisica/introducaoaoestudodafisica/conteudo.html
</html>