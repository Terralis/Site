...
<?php
    ...
    $get_conteudo = mysqli_query($conexao, "SELECT * FROM tema WHERE id_tema = 10");
						...
						<div class="wrapper-child" >
							...
							<div class="tab" name="video" id="video">
								<div class="material-video">
									<iframe width="600" height="337" src="https://www.youtube.com/embed/N33jWXzV8RU" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
									<iframe width="600" height="337" src="https://www.youtube.com/embed/rjH2xzCwNx0" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
								</div>
							</div>
						</div>
					</div>
					<div class="bt-bio">
						<a  href="citologia.php">Responder ao questionário</a>
					</div>
				</div>
			</div>
