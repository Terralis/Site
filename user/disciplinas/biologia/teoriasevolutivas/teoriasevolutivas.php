			...
			<div class="quiz-box custom-box">
				...
				<div class="option-container option-container">
					<form method="post">
						...
						<label for="alternativa5q7"><?php echo $alternativa5q7 ?></label>
						<br>
						<input type="submit" name="confirmar" value="Confirmar resposta">
					</form>
					<?php
				...
				<div class="option-container option-container lacuna">
					<form method="post">
						...
						<input type="text" name="questao13" id="alternativa1q13">
						<br>
						<input type="submit" name="confirmar" value="Confirmar resposta">
					</form>
					<?php
				...
				<div class="option-container option-container lacuna">
					<form method="post">
						...
						<input type="text" name="questao14" id="alternativa1q14">
						<br>
						<input type="submit" name="confirmar" value="Confirmar resposta">
					</form>
					<?php
				...
				<div class="option-container option-container lacuna">
					<form method="post">
						...
						<input type="text" name="questao15" id="alternativa1q15">
						<br>
						<input type="submit" name="confirmar" value="Confirmar resposta">
					</form>
					<?php
				...
				<div class="option-container option-container lacuna">
					<form method="post">
						...
						<input type="text" name="questao16" id="alternativa1q16">
						<br>
						<input type="submit" name="confirmar" value="Confirmar resposta">
					</form>
					<?php
