...
<?php
	...
	$get_pontuacao_correta = "SELECT * FROM desempenho WHERE desempenho.id_usuario = $seu_id AND desempenho.id_questionario = 19";
	$pontuacao_correta = mysqli_query($conexao, $get_pontuacao_correta);

	$get_pontuacao_errada = "SELECT * FROM desempenho WHERE desempenho.id_usuario = $seu_id AND desempenho.id_questionario = 19";
	$pontuacao_errada = mysqli_query($conexao, $get_pontuacao_errada);

	// questão 1
	$pergunta1 = "SELECT * FROM questao WHERE questao.id_questao = 93";
	$id_questao1 = mysqli_query($conexao, $pergunta1);
	$questao1 = mysqli_query($conexao, $pergunta1);
	
	$get_alternativas1 = "SELECT * FROM alternativa WHERE alternativa.id_questao = 93";
	$opcoes1 = mysqli_query($conexao, $get_alternativas1);
	// questão 2
	$pergunta2 = "SELECT * FROM questao WHERE questao.id_questao = 94";
	$id_questao2 = mysqli_query($conexao, $pergunta2);
	$questao2 = mysqli_query($conexao, $pergunta2);
	
	$get_alternativas2 = "SELECT * FROM alternativa WHERE alternativa.id_questao = 94";
	$opcoes2 = mysqli_query($conexao, $get_alternativas2);
	// questão 3
	$pergunta3 = "SELECT * FROM questao WHERE questao.id_questao = 95";
	$id_questao3 = mysqli_query($conexao, $pergunta3);
	$questao3 = mysqli_query($conexao, $pergunta3);
	
	$get_alternativas3 = "SELECT * FROM alternativa WHERE alternativa.id_questao = 95";
	$opcoes3 = mysqli_query($conexao, $get_alternativas3);
	// questão 4
	$pergunta4 = "SELECT * FROM questao WHERE questao.id_questao = 96";
	$id_questao4 = mysqli_query($conexao, $pergunta4);
	$questao4 = mysqli_query($conexao, $pergunta4);
	
	$get_alternativas4 = "SELECT * FROM alternativa WHERE alternativa.id_questao = 96";
	$opcoes4 = mysqli_query($conexao, $get_alternativas4);
	// questão 5
	$pergunta5 = "SELECT * FROM questao WHERE questao.id_questao = 193";
	$id_questao5 = mysqli_query($conexao, $pergunta5);
	$questao5 = mysqli_query($conexao, $pergunta5);
	
	$get_alternativas5 = "SELECT * FROM alternativa WHERE alternativa.id_questao = 193";
	$opcoes5 = mysqli_query($conexao, $get_alternativas5);
	// questão 6
	$pergunta6 = "SELECT * FROM questao WHERE questao.id_questao = 194";
	$id_questao6 = mysqli_query($conexao, $pergunta6);
	$questao6 = mysqli_query($conexao, $pergunta6);
	
	$get_alternativas6 = "SELECT * FROM alternativa WHERE alternativa.id_questao = 194";
	$opcoes6 = mysqli_query($conexao, $get_alternativas6);
	// questão 7
	$pergunta7 = "SELECT * FROM questao WHERE questao.id_questao = 195";
	$id_questao7 = mysqli_query($conexao, $pergunta7);
	$questao7 = mysqli_query($conexao, $pergunta7);
	
	$get_alternativas7 = "SELECT * FROM alternativa WHERE alternativa.id_questao = 195";
	$opcoes7 = mysqli_query($conexao, $get_alternativas7);
	// questão 8
	$pergunta8 = "SELECT * FROM questao WHERE questao.id_questao = 196";
	$id_questao8 = mysqli_query($conexao, $pergunta8);
	$questao8 = mysqli_query($conexao, $pergunta8);
	
	$get_alternativas8 = "SELECT * FROM alternativa WHERE alternativa.id_questao = 196";
	$opcoes8 = mysqli_query($conexao, $get_alternativas8);
	// questão 9
	$pergunta9 = "SELECT * FROM questao WHERE questao.id_questao = 218";
	$id_questao9 = mysqli_query($conexao, $pergunta9);
	$questao9 = mysqli_query($conexao, $pergunta9);
	
	$get_alternativas9 = "SELECT * FROM alternativa WHERE alternativa.id_questao = 218";
	$opcoes9 = mysqli_query($conexao, $get_alternativas9);
	// questão 10
	$pergunta10 = "SELECT * FROM questao WHERE questao.id_questao = 219";
	$id_questao10 = mysqli_query($conexao, $pergunta10);
	$questao10 = mysqli_query($conexao, $pergunta10);
	
	$get_alternativas10 = "SELECT * FROM alternativa WHERE alternativa.id_questao = 219";
	$opcoes10 = mysqli_query($conexao, $get_alternativas10);
	// questão 11
	$pergunta11 = "SELECT * FROM questao WHERE questao.id_questao = 220";
	$id_questao11 = mysqli_query($conexao, $pergunta11);
	$questao11 = mysqli_query($conexao, $pergunta11);
	
	$get_alternativas11 = "SELECT * FROM alternativa WHERE alternativa.id_questao = 220";
	$opcoes11 = mysqli_query($conexao, $get_alternativas11);
	// questão 12
	$pergunta12 = "SELECT * FROM questao WHERE questao.id_questao = 221";
	$id_questao12 = mysqli_query($conexao, $pergunta12);
	$questao12 = mysqli_query($conexao, $pergunta12);
	
	$get_alternativas12 = "SELECT * FROM alternativa WHERE alternativa.id_questao = 221";
	$opcoes12 = mysqli_query($conexao, $get_alternativas12);
	// questão 13
	$pergunta13 = "SELECT * FROM questao WHERE questao.id_questao = 293";
	$id_questao13 = mysqli_query($conexao, $pergunta13);
	$questao13 = mysqli_query($conexao, $pergunta13);
	
	$get_alternativas13 = "SELECT * FROM alternativa WHERE alternativa.id_questao = 293";
	$opcoes13 = mysqli_query($conexao, $get_alternativas13);
	// questão 14
	$pergunta14 = "SELECT * FROM questao WHERE questao.id_questao = 294";
	$id_questao14 = mysqli_query($conexao, $pergunta14);
	$questao14 = mysqli_query($conexao, $pergunta14);
	
	$get_alternativas14 = "SELECT * FROM alternativa WHERE alternativa.id_questao = 294";
	$opcoes14 = mysqli_query($conexao, $get_alternativas14);
	// questão 15
	$pergunta15 = "SELECT * FROM questao WHERE questao.id_questao = 295";
	$id_questao15 = mysqli_query($conexao, $pergunta15);
	$questao15 = mysqli_query($conexao, $pergunta15);
	
	$get_alternativas15 = "SELECT * FROM alternativa WHERE alternativa.id_questao = 295";
	$opcoes15 = mysqli_query($conexao, $get_alternativas15);
	// questão 16
	$pergunta16 = "SELECT * FROM questao WHERE questao.id_questao = 296";
	$id_questao16 = mysqli_query($conexao, $pergunta16);
	$questao16 = mysqli_query($conexao, $pergunta16);
	
	$get_alternativas16 = "SELECT * FROM alternativa WHERE alternativa.id_questao = 296";
						...
						<form method="post">
							<?php
								...
								// $id = (string) trim($row_alternativa['id_questao']);
									if ($row_alternativa['id_alternativa'] == 439) {
										$alternativa1 = $row_alternativa['texto'];
										// echo $alternativa1;
									}
									if ($row_alternativa['id_alternativa'] == 440) {
										$alternativa2 = $row_alternativa['texto'];
										// echo $alternativa1;
									}
									if ($row_alternativa['id_alternativa'] == 441) {
										$alternativa3 = $row_alternativa['texto'];
										// echo $alternativa1;
									}
									if ($row_alternativa['id_alternativa'] == 442) {
										$alternativa4 = $row_alternativa['texto'];
										// echo $alternativa1;
									}
									if ($row_alternativa['id_alternativa'] == 443) {
						...
						<?php
							...
							if(isset($escolha)){
								...
								$confirmar = mysqli_query($conexao, "UPDATE controle_resposta SET respondida = 1 WHERE id_questao = $id");
									...
									$up = mysqli_query($conexao, "UPDATE desempenho SET qtd_questao_correta = qtd_questao_correta + 1 WHERE id_usuario = $seu_id AND id_questionario = 19");
								}
								else{ 
								$confirmar = mysqli_query($conexao, "UPDATE controle_resposta SET respondida = 1 WHERE id_questao = $id");

									$down = mysqli_query($conexao, "UPDATE desempenho SET qtd_questao_errada = qtd_questao_errada + 1 WHERE id_usuario = $seu_id AND id_questionario = 19");
					...
					<div class="question-box">
						...
						<div class="question-text">
							<?php
								...
								echo $row_questao['enunciado'];
								echo "<br>";
								echo "<img id=margin src=../../../../img/img-id94.png>";
								echo "<br>";
								echo "<img id=margin src=../../../../img/img-id94(2).png>";
								}
							?>		
						</div>
					</div>
					<div class="option-container option-container-qui">
						<form method="post">
							<?php
								...
								// $id = (string) trim($row_alternativa['id_questao']);
									if ($row_alternativaQ2['id_alternativa'] == 444) {
										$alternativa1q2 = $row_alternativaQ2['texto'];
										// echo $alternativa1;
									}
									if ($row_alternativaQ2['id_alternativa'] == 445) {
										$alternativa2q2 = $row_alternativaQ2['texto'];
										// echo $alternativa1;
									}
									if ($row_alternativaQ2['id_alternativa'] == 446) {
										$alternativa3q2 = $row_alternativaQ2['texto'];
										// echo $alternativa1;
									}
									if ($row_alternativaQ2['id_alternativa'] == 447) {
										$alternativa4q2 = $row_alternativaQ2['texto'];
										// echo $alternativa1;
									}
									if ($row_alternativaQ2['id_alternativa'] == 448) {
					...
					<div class="question-box">
						...
						<div class="question-text">
							<?php
								...
								echo $row_questao['enunciado'];
								echo "<br>";
								echo "<img id=margin src=../../../../img/img-id95.png>";
								}
							?>		
						</div>
					</div>
					<div class="option-container option-container-qui">
						<form method="post">
							<?php
								...
								// $id = (string) trim($row_alternativa['id_questao']);
									if ($row_alternativaQ3['id_alternativa'] == 449) {
										$alternativa1q3 = $row_alternativaQ3['texto'];
										// echo $alternativa1;
									}
									if ($row_alternativaQ3['id_alternativa'] == 450) {
										$alternativa2q3 = $row_alternativaQ3['texto'];
										// echo $alternativa1;
									}
									if ($row_alternativaQ3['id_alternativa'] == 451) {
										$alternativa3q3 = $row_alternativaQ3['texto'];
										// echo $alternativa1;
									}
									if ($row_alternativaQ3['id_alternativa'] == 452) {
										$alternativa4q3 = $row_alternativaQ3['texto'];
										// echo $alternativa1;
									}
									if ($row_alternativaQ3['id_alternativa'] == 453) {
					...
					<div class="question-box">
						...
						<div class="question-text">
							<?php
								...
								echo $row_questao['enunciado'];
								echo "<br>";
								echo "<img id=margin src=../../../../img/img-id96.png>";
								}
							?>		
						</div>
					</div>
					<div class="option-container option-container-qui">
						<form method="post">
							<?php
								...
								// $id = (string) trim($row_alternativa['id_questao']);
									if ($row_alternativaQ4['id_alternativa'] == 454) {
										$alternativa1q4 = $row_alternativaQ4['texto'];
										// echo $alternativa1;
									}
									if ($row_alternativaQ4['id_alternativa'] == 455) {
										$alternativa2q4 = $row_alternativaQ4['texto'];
										// echo $alternativa1;
									}
									if ($row_alternativaQ4['id_alternativa'] == 456) {
										$alternativa3q4 = $row_alternativaQ4['texto'];
										// echo $alternativa1;
									}
									if ($row_alternativaQ4['id_alternativa'] == 457) {
										$alternativa4q4 = $row_alternativaQ4['texto'];
										// echo $alternativa1;
									}
									if ($row_alternativaQ4['id_alternativa'] == 458) {
					...
					<div class="question-box">
						...
						<div class="question-text">
							<?php
								...
								echo $row_questao['enunciado'];
								echo "<br>";
								echo "<img id=margin src=../../../../img/img-id193.png>";
								}
							?>		
						</div>
					</div>
					<div class="option-container option-container-qui lacuna">
						<form method="post">
							<?php
								...
								// $id = (string) trim($row_alternativa['id_questao']);
									if ($row_alternativaQ5['id_alternativa'] == 611) {
										$alternativa1q5 = trim($row_alternativaQ5['texto']);
										// echo $alternativa1;
									}
									if ($row_alternativaQ5['id_alternativa'] == 612) {
										$alternativa2q5 = trim($row_alternativaQ5['texto']);
										// echo $alternativa1;
									}
							...
							<input type="text" name="questao5a" id="alternativa1q5">
							<br>
							<label for="alternativa2q5">Insira a resposta:</label>
							<input type="text" name="questao5b" id="alternativa2q5">
							<br>
							<div class="btn-box">
								<div class="previous-question-btn">
					...
					<div class="question-box">
						...
						<div class="question-text">
							<?php
								...
								echo $row_questao['enunciado'];
								echo "<br>";
								echo "<img id=margin src=../../../../img/img-id194.png>";
								}
							?>		
						</div>
					</div>
					<div class="option-container option-container-qui lacuna">
						<form method="post">
							<?php
								...
								// $id = (string) trim($row_alternativa['id_questao']);
									if ($row_alternativaQ6['id_alternativa'] == 613) {
										$alternativa1q6 = (string) trim($row_alternativaQ6['texto']);
										// echo $alternativa1;
									}
							...
							?>
							<label for="alternativa1q6">Ligação 1:</label>
					...
					<div class="question-box">
						...
						<div class="question-text">
							<?php
								...
								echo $row_questao['enunciado'];
								echo "<br>";
								echo "<img id=margin src=../../../../img/img-id195.png>";
								}
							?>		
						</div>
					</div>
					<div class="option-container option-container-qui lacuna">
						<form method="post">
							<?php
								...
								// $id = (string) trim($row_alternativa['id_questao']);
									if ($row_alternativaQ7['id_alternativa'] == 614) {
					...
					<div class="question-box">
						...
						<div class="question-text">
							<?php
								...
								echo $row_questao['enunciado'];
								echo "<br>";
								echo "<img id=margin src=../../../../img/img-id196.png>";
								echo "<br>";
								echo "<img id=margin src=../../../../img/img-id196(2).png>";
								}
							?>		
						</div>
					</div>
					<div class="option-container option-container-qui lacuna">
						<form method="post">
							<?php
								...
								// $id = (string) trim($row_alternativa['id_questao']);
									if ($row_alternativaQ8['id_alternativa'] == 615) {
					...
					<div class="question-box">
						...
						<div class="question-text">
							<?php
								...
								echo $row_questao['enunciado'];
								echo "<br>";
								echo "<img id=margin src=../../../../img/img-id218.png>";
								}
							?>		
						</div>
					</div>
					<div class="option-container option-container-qui">
						<form method="post">
							<?php
								...
								// $id = (string) trim($row_alternativa['id_questao']);
									if ($row_alternativaQ9['id_alternativa'] == 678) {
										$alternativa1q9 = $row_alternativaQ9['texto'];
										// echo $alternativa1;
									}
									if ($row_alternativaQ9['id_alternativa'] == 679) {
					...
					<div class="question-box">
						...
						<div class="question-text">
							<?php
								...
								echo $row_questao['enunciado'];
								echo "<br>";
								echo "<img id=margin src=../../../../img/img-id219.png>";
								}
							?>		
						</div>
					</div>
					<div class="option-container option-container-qui">
						<form method="post">
							<?php
								...
								// $id = (string) trim($row_alternativa['id_questao']);
									if ($row_alternativaQ10['id_alternativa'] == 680) {
										$alternativa1q10 = $row_alternativaQ10['texto'];
										// echo $alternativa1;
									}
									if ($row_alternativaQ10['id_alternativa'] == 681) {
					...
					<div class="question-box">
						...
						<div class="question-text">
							<?php
								...
								echo $row_questao['enunciado'];
								echo "<br>";
								echo "<img id=margin src=../../../../img/img-id220.png>";
								}
							?>		
						</div>
					</div>
					<div class="option-container option-container-qui">
						<form method="post">
							<?php
								...
								// $id = (string) trim($row_alternativa['id_questao']);
									if ($row_alternativaQ11['id_alternativa'] == 682) {
										$alternativa1q11 = $row_alternativaQ11['texto'];
										// echo $alternativa1;
									}
									if ($row_alternativaQ11['id_alternativa'] == 683) {
					...
					<div class="question-box">
						...
						<div class="question-text">
							<?php
								...
								echo $row_questao['enunciado'];
								echo "<br>";
								echo "<img id=margin src=../../../../img/img-id221.png>";
								echo "<br>";
								echo "<img id=margin src=../../../../img/img-id221(2).png>";
								}
							?>		
						</div>
					</div>
					<div class="option-container option-container-qui">
						<form method="post">
							<?php
								...
								// $id = (string) trim($row_alternativa['id_questao']);
									if ($row_alternativaQ12['id_alternativa'] == 684) {
										$alternativa1q12 = $row_alternativaQ12['texto'];
										// echo $alternativa1;
									}
									if ($row_alternativaQ12['id_alternativa'] == 685) {
					...
					<div class="question-box">
						...
						<div class="question-text">
							<?php
								...
								echo $row_questao['enunciado'];
								echo "<br>";
								echo "<img id=margin src=../../../../img/img-id293.png>";
								}
							?>		
						</div>
					</div>
					<div class="option-container option-container-qui lacuna">
						<form method="post">
							<?php
								...
								// $id = (string) trim($row_alternativa['id_questao']);
									if ($row_alternativaQ13['id_alternativa'] == 824) {
					...
					<div class="question-box">
						...
						<div class="question-text">
							<?php
								...
								echo $row_questao['enunciado'];
								echo "<br>";
								echo "<img id=margin src=../../../../img/img-id294.png>";
								}
							?>		
						</div>
					</div>
					<div class="option-container option-container-qui lacuna">
						<form method="post">
							<?php
								...
								// $id = (string) trim($row_alternativa['id_questao']);
									if ($row_alternativaQ14['id_alternativa'] == 825) {
					...
					<div class="question-box">
						...
						<div class="question-text">
							<?php
								...
								echo $row_questao['enunciado'];
								echo "<br>";
								echo "<img id=margin src=../../../../img/img-id295.png>";
								}
							?>		
						</div>
					</div>
					<div class="option-container option-container-qui lacuna">
						<form method="post">
							<?php
								...
								// $id = (string) trim($row_alternativa['id_questao']);
									if ($row_alternativaQ15['id_alternativa'] == 826) {
					...
					<div class="question-box">
						...
						<div class="question-text">
							<?php
								...
								echo $row_questao['enunciado'];
								echo "<br>";
								echo "<img id=margin src=../../../../img/img-id296.png>";
								}
							?>		
						</div>
					</div>
					<div class="option-container option-container-qui lacuna">
						<form method="post">
							<?php
								...
								// $id = (string) trim($row_alternativa['id_questao']);
									if ($row_alternativaQ16['id_alternativa'] == 827) {
