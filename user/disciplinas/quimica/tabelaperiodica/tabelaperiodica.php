...
<?php
	...
	$get_pontuacao_correta = "SELECT * FROM desempenho WHERE desempenho.id_usuario = $seu_id AND desempenho.id_questionario = 17";
	$pontuacao_correta = mysqli_query($conexao, $get_pontuacao_correta);

	$get_pontuacao_errada = "SELECT * FROM desempenho WHERE desempenho.id_usuario = $seu_id AND desempenho.id_questionario = 17";
					...
					<div class="question-box">
						...
						<div class="question-text">
							<?php
								...
								echo "<br>";
								echo "<img id=margin src=../../../../img/img-id85-01.png>";
								echo "<br>";
								echo "<img id=margin src=../../../../img/img-id85-02.png>";
								}
							?>		
						</div>
					</div>
						...
						<?php
							...
							if(isset($escolha)){
								...
								$confirmar = mysqli_query($conexao, "UPDATE controle_resposta SET respondida = 1 WHERE id_questao = $id");
									...
									$up = mysqli_query($conexao, "UPDATE desempenho SET qtd_questao_correta = qtd_questao_correta + 1 WHERE id_usuario = $seu_id AND id_questionario = 17");
								}
								else{ 
								$confirmar = mysqli_query($conexao, "UPDATE controle_resposta SET respondida = 1 WHERE id_questao = $id");

									$down = mysqli_query($conexao, "UPDATE desempenho SET qtd_questao_errada = qtd_questao_errada + 1 WHERE id_usuario = $seu_id AND id_questionario = 17");
					...
					<div class="question-box">
						...
						<div class="question-text">
							<?php
								...
								echo $row_questao['enunciado'];
								echo "<br>";
								echo "<img id=margin src=../../../../img/img-id86.png>";
								}
							?>		
						</div>
					</div>
					...
					<div class="question-box">
						...
						<div class="question-text">
							<?php
								...
								echo $row_questao['enunciado'];
								echo "<br>";
								echo "<img id=margin src=../../../../img/img-id87.png>";
								}
							?>		
						</div>
					</div>
					...
					<div class="question-box">
						...
						<div class="question-text">
							<?php
								...
								echo $row_questao['enunciado'];
								echo "<br>";
								echo "<img id=margin src=../../../../img/img-id88.png>";
								}
							?>		
						</div>
					</div>
					...
					<div class="question-box">
						...
						<div class="question-text">
							<?php
								...
								echo $row_questao['enunciado'];
								echo "<br>";
								echo "<img id=margin src=../../../../img/img-id185.png>";
								}
							?>		
						</div>
					</div>
					<div class="option-container option-container-qui lacuna">
						...
						<?php
							...
							if ($bt5_origemdavida == true) {
								...
								if(isset($resposta5x) && isset($resposta5y)){
								$confirmar = mysqli_query($conexao, "UPDATE controle_resposta SET respondida = 1 WHERE id_questao = $id");
								if(($resposta5x === $alternativa1q5x) && ($resposta5y === $alternativa1q5y)){
								echo '<style type/css>
									#alternativa1q5x, #alternativa1q5y{
											border: 2px solid green;
										background-color: #d2e8cf;
									}
									</style>';
								...
								elseif(isset($_POST['questao5x']) && isset($_POST['questao5y'])){

									echo "Resposta correta:";
                                    echo "<br>";
                                    echo $alternativa1q5x;
                                    echo "<br>";
                                    echo $alternativa1q5y;
                                    echo "<br>";
				...
				<div class="whole-question" id="6">
					...
					<div class="option-container option-container-qui lacuna">
						...
						<?php
							...
							if(isset($resposta6a) && isset($resposta6b) && isset($resposta6c) && isset($resposta6d) && isset($resposta6e)){
								...
								$confirmar = mysqli_query($conexao, "UPDATE controle_resposta SET respondida = 1 WHERE id_questao = $id");
								echo '<style type/css>
									#alternativa1q6, #alternativa2q6, #alternativa3q6, #alternativa4q6, #alternativa5q6{
										border: 2px solid green;
										background-color: #d2e8cf;
									}
									</style>';
								...
								elseif(isset($_POST['questao6a']) && isset($_POST['questao6b']) && isset($_POST['questao6c']) && isset($_POST['questao6d']) && isset($_POST['questao6e'])){
					...
					<div class="question-box">
						...
						<div class="question-text">
							<?php
								...
								echo $row_questao['enunciado'];
								echo "<br>";
								echo "<img id=margin src=../../../../img/img-id187.png>";
								}
							?>		
						</div>
					</div>
					...
					<div class="question-box">
						...
						<div class="question-text">
							<?php
								...
								echo $row_questao['enunciado'];
								echo "<br>";
								echo "<img id=margin src=../../../../img/img-id188.png>";
								}
							?>		
						</div>
					</div>
					...
					<div class="question-box">
						...
						<div class="question-text">
							<?php
								...
								echo $row_questao['enunciado'];
								echo "<br>";
								echo "<img id=margin src=../../../../img/img-id211.png>";
								}
							?>		
						</div>
					</div>
					...
					<div class="question-box">
						...
						<div class="question-text">
							<?php
								...
								echo $row_questao['enunciado'];
								echo "<br>";
								echo "<img id=margin src=../../../../img/img-id212.png>";
								}
							?>		
						</div>
					</div>
					...
					<div class="question-box">
						...
						<div class="question-text">
							<?php
								...
								echo $row_questao['enunciado'];
								echo "<br>";
								echo "<img id=margin src=../../../../img/img-id213.png>";
								}
							?>		
						</div>
					</div>
					...
					<div class="question-box">
						...
						<div class="question-text">
							<?php
								...
								echo $row_questao['enunciado'];
								echo "<br>";
								echo "<img id=margin src=../../../../img/img-id285.png>";
								}
							?>		
						</div>
					</div>
					...
					<div class="question-box">
						...
						<div class="question-text">
							<?php
								...
								echo $row_questao['enunciado'];
								echo "<br>";
								echo "<img id=margin src=../../../../img/img-id286.png>";
								}
							?>		
						</div>
					</div>
					...
					<div class="question-box">
						...
						<div class="question-text">
							<?php
								...
								echo $row_questao['enunciado'];
								echo "<br>";
								echo "<img id=margin src=../../../../img/img-id287.png>";
								}
							?>		
						</div>
					</div>
					...
					<div class="question-box">
						...
						<div class="question-text">
							<?php
								...
								echo $row_questao['enunciado'];
								echo "<br>";
								echo "<img id=margin src=../../../../img/img-id288-01.png>";
								echo "<br>";
								echo "<img id=margin src=../../../../img/img-id288-02.png>";
								}
							?>		
						</div>
					</div>
